...
Jeg kan godt lide at arbejde atomiseret, altså at bygge UI af en masse små komponenter. Tailwind gør, at min styling og markup hænger tæt sammen, hvilket betyder, at jeg kan iterere hurtigere, da jeg ikke skal navigere imellem tonsvis af filer.
...
Jeg har valgt at løse valgfri opgave B, hvor man skal kunne oprette en bruger.
...
Jeg vil gerne have at brugeren skal kunne se details siden UDEN at være logget ind, så derfor:
...
Lige nu er der kun 4 elementer i classesData, så det her er ikke et problem. Men lad os sige at appen vokser og der pludselig er 1000 classes. Ja, så vil denne lille kode bid være meget tung for backenden, da der ville blive lavet 1000 requests på samme tid og 1000 Promises der forsøger at blive resolved parallelt. Det kan i værste tilfælde føre til et crash af backend serveren eller en 429 (Too many requests) HTTP error.
